...
// 1. สร้าง Type สำหรับ Props ที่ Controller ส่งมา
...
export default function UserCreate({ auth, companies, roles }: CreatePageProps) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        company_id: '',
        // role_id: '',    // (ของเดิม)
        role_ids: [] as number[], // <-- (ของใหม่) เป็น Array
        is_active: true,
    });
                                        ...
                                        {roles.map((role) => (
                                            <div key={role.id} className="flex items-center space-x-2">
                                                <Checkbox
                                                    ...
                                                    // ห้ามกำหนดสิทธิ์ Super Admin ให้คนอื่น
